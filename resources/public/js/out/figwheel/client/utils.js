...
return (new CustomEvent(event_name,(function (){var obj32172 = {"detail":data};
return obj32172;
})()));
} else {
...
var and__25282__auto____$1 = (window["CustomEvent"]);
...
var args32177 = [];
var len__26407__auto___32183 = arguments.length;
var i__26408__auto___32184 = (0);
while(true){
if((i__26408__auto___32184 < len__26407__auto___32183)){
args32177.push((arguments[i__26408__auto___32184]));

var G__32185 = (i__26408__auto___32184 + (1));
i__26408__auto___32184 = G__32185;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32177.length)].join('')));
...
var f = (function (){var pred__32180 = cljs.core._EQ_;
var expr__32181 = (cljs.core.truth_(figwheel.client.utils.html_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32180.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32181))){
return ((function (pred__32180,expr__32181){
return (function (p1__32173_SHARP_){
return console.warn(p1__32173_SHARP_);
});
;})(pred__32180,expr__32181))
} else {
if(cljs.core.truth_(pred__32180.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32181))){
return ((function (pred__32180,expr__32181){
return (function (p1__32174_SHARP_){
return console.debug(p1__32174_SHARP_);
});
;})(pred__32180,expr__32181))
} else {
if(cljs.core.truth_(pred__32180.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32181))){
return ((function (pred__32180,expr__32181){
return (function (p1__32175_SHARP_){
return console.error(p1__32175_SHARP_);
});
;})(pred__32180,expr__32181))
} else {
return ((function (pred__32180,expr__32181){
return (function (p1__32176_SHARP_){
return console.log(p1__32176_SHARP_);
});
;})(pred__32180,expr__32181))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32187){
var map__32190 = p__32187;
...
var eval_fn = cljs.core.get.call(null,map__32190__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32192_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__32194,(0),null);
var v = cljs.core.nth.call(null,vec__32194,(1),null);
...
var args32197 = [];
var len__26407__auto___32200 = arguments.length;
var i__26408__auto___32201 = (0);
while(true){
if((i__26408__auto___32201 < len__26407__auto___32200)){
args32197.push((arguments[i__26408__auto___32201]));

var G__32202 = (i__26408__auto___32201 + (1));
i__26408__auto___32201 = G__32202;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args32197.length)].join('')));
...
if(cljs.core.truth_((function (){var and__25282__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1494243347898